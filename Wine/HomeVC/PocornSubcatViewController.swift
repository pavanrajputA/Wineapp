//
//  PocornSubcatViewController.swift
//  Wine
//
...
class PocornSubcatViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout  {
    ...
    override func viewDidLoad() {
        ...
        if !reachability.isReachable
        {
           ...
           self.listSubsubCategories_API(type: "\(id)")
            }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if dict!["subId"] as! String == "yes"{
            ...
            let NextPage = self.storyboard?.instantiateViewController(withIdentifier: "PocornSubcat2ViewController") as! PocornSubcat2ViewController
           // NextPage.selectedType =  dict!["name"] as! String
            NextPage.dataForSubcategories = dict as! NSDictionary
    ...
    //MARK:-  ApI Call ///
    /**************************************************************************/
    func listSubsubCategories_API(type:String) {
        MBProgressHUD.showAdded(to: self.view, animated: true)
        let parameters: Parameters = ["id" : type]
        let urlString = listSubsubCategories
